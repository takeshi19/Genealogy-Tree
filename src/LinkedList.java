...
public class LinkedList<E> implements ListADT<E> {
	 ...
	 *  
	 * @param data the data of the new node being constructed.
	 * @param pos the position to add new node to.
	 */
	 ...
	 * @return true iff item is in the List, false otherwise.
	 */
	 ...
	 * 
	 * @return a reference to the header node of this list. 
	 */
